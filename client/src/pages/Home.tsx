        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg leading-relaxed text-foreground/80" data-testid="text-mission-statement">
              We exist to build the best marketplace for archive designer fashion—one that charges just $1 per sale, pays sellers fast, and prioritizes trust above all else. Our platform bridges the gap between Instagram sellers and a fully secure marketplace, making buying and selling rare fashion simple, fast, and safe.
            </p>
